...
##########taiji with lensing   in  five years
############Q3nod
'''
for i in range(0,num):
    for j in range(0,N):
...
#taiji with lensing in  5years
exec('first{}=[-1]'.format(0));exec('second{}=[1307,1106]'.format(0));exec('third{}=[-1]'.format(0));exec('four{}=[-1]'.format(0));
exec('first{}=[-1]'.format(1));exec('second{}=[-1]'.format(1));exec('third{}=[-1]'.format(1));exec('four{}=[1366]'.format(1));
exec('first{}=[-1]'.format(2));exec('second{}=[1343]'.format(2));exec('third{}=[-1]'.format(2));exec('four{}=[-1]'.format(2));
exec('first{}=[-1]'.format(3));exec('second{}=[-1]'.format(3));exec('third{}=[1184]'.format(3));exec('four{}=[-1]'.format(3));
exec('first{}=[1181]'.format(4));exec('second{}=[-1]'.format(4));exec('third{}=[1016]'.format(4));exec('four{}=[1197]'.format(4));
exec('first{}=[902]'.format(5));exec('second{}=[-1]'.format(5));exec('third{}=[1024,1293]'.format(5));exec('four{}=[1031,1102]'.format(5));
exec('first{}=[-1]'.format(6));exec('second{}=[-1]'.format(6));exec('third{}=[-1]'.format(6));exec('four{}=[1345]'.format(6));
exec('first{}=[-1]'.format(7));exec('second{}=[-1]'.format(7));exec('third{}=[-1]'.format(7));exec('four{}=[1439]'.format(7));
exec('first{}=[-1]'.format(8));exec('second{}=[-1]'.format(8));exec('third{}=[1037]'.format(8));exec('four{}=[912]'.format(8));
exec('first{}=[-1]'.format(9));exec('second{}=[-1]'.format(9));exec('third{}=[1341]'.format(9));exec('four{}=[-1]'.format(9));
...
for datanum in range(0,5):
    ...
    CQ3nod1=plt.contourf(X, Y, dN_dtdzdM3, list,cmap=plt.cm.Greys,alpha=0.5,extend='min')
    CQ3nod= plt.contour(X, Y, dN_dtdzdM3, list,colors=['k','k','k','k','k','k'])
    plt.clabel(CQ3nod, inline=1, inline_spacing=0,fontsize=9,fmt='%1.1f')
    ...
    #plt.legend(loc = 'upper right')
    #plt.title('Q3nod w/ lensing noise in network')
    plt.title('Q3nod in Taiji',fontdict={"size":30})
    plt.xlim(0,20)
    plt.ylim(3.5,10.0)
    plt.ylabel('$\log_{10}{[M_c/M_{\odot}]}$', fontsize = 30)
    plt.xlabel('Redshift ($z$)', fontsize =30)
    #plt.savefig("fiveyears/network/lens/Q3nodlens%d.png"%datanum, dpi=300)
    plt.savefig("fiveyears/taiji/lens/taiji_Q3nod_lens%d.pdf"%datanum)
    plt.show() 
...
exec('first{}=[-1]'.format(0));exec('second{}=[-1]'.format(0));exec('third{}=[-1]'.format(0));exec('four{}=[-1]'.format(0));
exec('first{}=[-1]'.format(1));exec('second{}=[-1]'.format(1));exec('third{}=[-1]'.format(1));exec('four{}=[-1]'.format(1));
exec('first{}=[-1]'.format(2));exec('second{}=[316]'.format(2));exec('third{}=[-1]'.format(2));exec('four{}=[-1]'.format(2));
exec('first{}=[-1]'.format(3));exec('second{}=[-1]'.format(3));exec('third{}=[-1]'.format(3));exec('four{}=[217]'.format(3));
exec('first{}=[-1]'.format(4));exec('second{}=[-1]'.format(4));exec('third{}=[590]'.format(4));exec('four{}=[222]'.format(4));
exec('first{}=[-1]'.format(5));exec('second{}=[-1]'.format(5));exec('third{}=[-1]'.format(5));exec('four{}=[-1]'.format(5));
exec('first{}=[-1]'.format(6));exec('second{}=[-1]'.format(6));exec('third{}=[555]'.format(6));exec('four{}=[-1]'.format(6));
exec('first{}=[517]'.format(7));exec('second{}=[-1]'.format(7));exec('third{}=[-1]'.format(7));exec('four{}=[-1]'.format(7));
exec('first{}=[-1]'.format(8));exec('second{}=[574]'.format(8));exec('third{}=[-1]'.format(8));exec('four{}=[-1]'.format(8));
exec('first{}=[-1]'.format(9));exec('second{}=[-1]'.format(9));exec('third{}=[-1]'.format(9));exec('four{}=[-1]'.format(9));
...
for datanum in range(4,5):
    ...
    plt.yticks(fontsize=20)    
    #plt.title('PopIII w/ lensing noise in network')
    plt.title('PopIII in Taiji',fontdict={'size':30})
    plt.xlim(0,20)
    plt.ylim(2.3,10.0)
    plt.ylabel('$\log_{10}{[M_c/M_{\odot}]}$', fontsize = 30)
    plt.xlabel('Redshift ($z$)', fontsize = 30)
    #plt.savefig("fiveyears/network/lens/PopIIIlens%d.png"%datanum, dpi=300)
    plt.savefig("fiveyears/taiji/lens/taiji_PopIII_lens%d.pdf"%datanum)
    plt.show() 
...
#taiji wirh lensing  in five years
exec('first{}=[-1]'.format(0));exec('second{}=[-1]'.format(0));exec('third{}=[-1]'.format(0));exec('four{}=[-1]'.format(0));
exec('first{}=[-1]'.format(1));exec('second{}=[-1]'.format(1));exec('third{}=[-1]'.format(1));exec('four{}=[-1]'.format(1));
exec('first{}=[-1]'.format(2));exec('second{}=[-1]'.format(2));exec('third{}=[-1]'.format(2));exec('four{}=[-1]'.format(2));
exec('first{}=[-1]'.format(3));exec('second{}=[-1]'.format(3));exec('third{}=[-1]'.format(3));exec('four{}=[-1]'.format(3));
exec('first{}=[-1]'.format(4));exec('second{}=[-1]'.format(4));exec('third{}=[859,867]'.format(4));exec('four{}=[-1]'.format(4));
exec('first{}=[-1]'.format(5));exec('second{}=[-1]'.format(5));exec('third{}=[-1]'.format(5));exec('four{}=[-1]'.format(5));
exec('first{}=[-1]'.format(6));exec('second{}=[-1]'.format(6));exec('third{}=[-1]'.format(6));exec('four{}=[-1]'.format(6));
exec('first{}=[-1]'.format(7));exec('second{}=[861]'.format(7));exec('third{}=[867]'.format(7));exec('four{}=[841]'.format(7));
exec('first{}=[-1]'.format(8));exec('second{}=[-1]'.format(8));exec('third{}=[-1]'.format(8));exec('four{}=[-1]'.format(8));
exec('first{}=[-1]'.format(9));exec('second{}=[-1]'.format(9));exec('third{}=[-1]'.format(9));exec('four{}=[-1]'.format(9));
...
for datanum in range(4,5):
    ...
    plt.yticks(fontsize=20)      
    #plt.title('Q3d w/ lensing noise in network')
    plt.title('Q3d in Taiji',fontdict={"size":30})
    plt.xlim(0,20)
    plt.ylim(3.0,10.0)
    plt.ylabel('$\log_{10}{[M_c/M_{\odot}]}$', fontsize = 30)
    plt.xlabel('Redshift ($z$)', fontsize = 30)
    #plt.savefig("fiveyears/network/lens/Q3dlens%d.png"%datanum,dpi=300 )
    plt.savefig("fiveyears/taiji/lens/taiji_Q3d_lens%d.pdf"%datanum)
    plt.show() 
...
for datanum in range(0,0):
    ...
    plt.xlim(0,20)
    plt.ylim(3.5,10.0)
    plt.ylabel('$\log_{10}{[M_c/M_{\odot}]}$', fontsize = 20)
    plt.xlabel('redshift ($z$)', fontsize = 20)
    plt.savefig("data/network/lens/Q3nodlens%d_1yr_net.png"%datanum, dpi=300)
